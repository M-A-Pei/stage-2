...
function Layout() {
  ...
  return (
    <Grid container>
      ...
      <Grid item xs={6} sx={{height: "100vh", bgcolor: "secondary.dark", color: "white", p:3, overflowY: "scroll"}}>
        <Outlet/>
      </Grid>
        ...
        <Stack direction="column" spacing={2} sx={{height: "100vh", p:2}}>
          ...
          <Box sx={{height: "60vh", bgcolor: "secondary.main", borderRadius: "20px", color: "white", p:2, overflowY: "scroll"}}>
            ...
            <Stack gap={2} direction="column">
              ...
              <MiniProfile username="Gojo Satoru" tag="@thechoseone" pfp='https://i.pinimg.com/736x/a6/67/73/a667732975f0f1da1a0fd4625e30d776.jpg'/>
